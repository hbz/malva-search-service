...
interface SRUConstants {
    ...
    String SRW_NS_URI = "http://www.loc.gov/zing/srw/"

    String SEARCH_RETRIEVE_NS_URI = "http://docs.oasis-open.org/ns/search-ws/sruResponse"
    ...
    String SEARCH_RETRIEVE_OPERATION = "searchRetrieve"
    
    String SCAN_OPERATION = "scan"
   ...
   /**
     ...
     */
    Map<String,URI> RECORD_SCHEMAS = [
        "dc": URI.create("info:srw/schema/1/dc-v1.1"),
        "diag": URI.create("info:srw/schema/1/diagnostic-v1.1"),
        "zeerex": URI.create("http://explain.z3950.org/dtd/2.0/"),
        "mods": URI.create("info:srw/schema/1/mods-v3.4"),
        "onix": URI.create("info:srw/schema/1/onix-v2.0"),
        "marcxml": URI.create("info:srw/schema/1/marcxml-v1.1"),
        "marcxchange" : URI.create("info:/srw/schema/9/marcxchange"),
        "mx": URI.create("info:/srw/schema/9/marcxchange"),
        "ead": URI.create("info:srw/schema/1/ead-2002"),
        "rec": URI.create("info:srw/schema/2/rec-1.0"),
        "unimarcxml": URI.create("info:srw/schema/8/unimarcxml-v0.1"),
        "dlxs-bib": URI.create("info:/srw/schema/10/dlxs-bib-v1.0"),
        "dcx": URI.create("info:/srw/schema/1/dcx-v1.0"),
        "pica-XML": URI.create("info:srw/schema/5/picaXML-v1.0"),
        "mads": URI.create("info:srw/schema/1/mads-v1.0"),
        "isohold": URI.create("info:srw/schema/5/iso20775-v1.0"),
        "pam": URI.create("info:srw/schema/11/pam-v2.1")
    ]
    
    Map<String,URI> RECORD_SCHEMA_NAMESPACES = [
        "mods": URI.create("http://www.loc.gov/mods/v3"),
        "mx": URI.create("info:lc/xmlns/marcxchange-v1"),
        "marcxml": URI.create("http://www.loc.gov/MARC21/slim")
    ]
}
